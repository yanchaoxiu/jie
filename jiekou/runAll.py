...
from jiekou.common import Log
from jiekou.common.configEmail import send_mail

import common.HTMLTestRunner as HTMLTestRunner
from jiekou import getpathInfo, readConfig
...
class AllTest:#定义一个类AllTest
    ...
    def run(self):
        ...
        if on_off == 'on':
            ...
            print(u"邮件发送开关配置关闭，请打开开关后可正常自动发送测试报告")
